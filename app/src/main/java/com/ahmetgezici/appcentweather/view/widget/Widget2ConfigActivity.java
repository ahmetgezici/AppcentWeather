...
public class Widget2ConfigActivity extends Activity {

    private static final String PREFS_NAME = "com.ahmetgezici.appcentweather.View.Weather2Widget";
    ...
    public void onCreate(Bundle icicle) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideKeyboard(Widget2ConfigActivity.this);
        ...
        complete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Context context = Widget2ConfigActivity.this;
                ...
                Weather2Widget.updateAppWidget(context, appWidgetManager, mAppWidgetId);
